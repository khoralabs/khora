...
Related: [`product/khora.md`](../product/khora.md), [`product/vellum.md`](../product/vellum.md), [`technical/discovery.md`](discovery.md), [`technical/vellum-rooms.md`](vellum-rooms.md), [`technical/room-lifecycle.md`](room-lifecycle.md), [`technical/obp-protocol.md`](obp-protocol.md), [`technical/host.md`](host.md), [`roadmap/open-questions.md`](../roadmap/open-questions.md).
...
| **P1 — Vellum relay server** | `apps/vellum/relay-server` (or similar): hub + SQLite/in-memory store, WS attach, spawn API | New app; no `@khoralabs/relay-colonnade` |
| **P2 — Vellum spawn API** | `POST /v1/rooms` on Vellum; returns `{ roomId, relayUrl, inviteToken?, expiresAtMs }` | Move logic from `apps/khora/server/src/http/rooms.ts`; Vellum client defaults to Vellum base URL for rooms |
