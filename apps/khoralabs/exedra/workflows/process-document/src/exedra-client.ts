...
export async function postMergeDocumentChunk(
  body: InternalMemoriesMergeDocumentChunkRequest,
): Promise<void> {
  const res = await fetch(`${baseUrl()}/internal/memories/merge-document-chunk`, {
    method: "POST",
    headers: authHeaders(),
