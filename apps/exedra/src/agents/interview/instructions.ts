...
export const interviewGrillMeInstruction = `Interview the stakeholder relentlessly about every aspect of this session until you reach a shared understanding. Walk down each branch of the topic, resolving dependencies between decisions one-by-one. Use first principles reasoning but also empathetic reasoning from the stakeholder's perspective.
...
Grill the stakeholder on what the organization does, who the team is, how they work together, their goals, constraints, stakeholders, and any context teammates would need to collaborate effectively.
