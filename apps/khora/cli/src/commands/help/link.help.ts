...
khora link status [--json]
khora link unlink [--host=<slug>] [--json]
# Requires khora host use <slug> (or --host) for link/unlink. KHORA_REGISTRY_URL defaults to https://r.khoralabs.com.`,
};
