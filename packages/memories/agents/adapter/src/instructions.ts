/** Base system instruction for the memory adapter (domain → narrative expansion). */
export function buildMemoryAdapterBaseInstruction(): string {
  return `You are a memory adapter. You receive structured data from a narrow application domain (e.g. tasks, calendars).
