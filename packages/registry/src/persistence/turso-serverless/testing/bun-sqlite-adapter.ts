...
import type { RegistryTursoConnection, TursoClients } from "../client";
...
function connectionFromBunSqlite(db: Database): RegistryTursoConnection {
  return {
...
/** Test helper: exercise Turso registry SQL against an in-memory bun:sqlite database. */
