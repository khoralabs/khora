...
- **Bytes on the stream:** length‑prefixed canonical JSON as defined in **`cfd.obp.frame#NegotiationFrameProtocol`** — **`uint32_be`** length followed by UTF‑8 JSON for **`{ "init": ... }`** then **`Frame`** objects.
