 ...
 */
export async function popInboxDrainItemsForDid(
  ctx: KhoraHostContext,
  did: string,
): Promise<InboxDrainItem[]> {
  ...
  const inlineItems: InboxDrainItem[] = [];
  ...
  const pointerItems: InboxDrainItem[] = [];
