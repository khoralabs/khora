...
/**
 * Translate `ATRIUM_*` env vars into a partial `AtriumAppConfigBase`. Hosts compose by spreading this and
 * adding their own keys before feeding the result into `loadAtriumAppConfig`.
 */
