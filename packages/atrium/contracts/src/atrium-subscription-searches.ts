import type { AtriumStandingSearchRequest } from "./atrium-standing-search.ts";

export const ATRIUM_TOPIC_LABEL_PREFIX = "atrium_topic:";
...
export function topicSubscriptionSearch(slug: string): AtriumStandingSearchRequest {
  return {
    content: {},
