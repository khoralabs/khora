...
let sharedNoopCatalog: NoopCatalogPersistence | undefined;

/** Shared singleton for clients that omit an explicit catalog strategy. */
export function defaultNoopCatalogPersistence(): NoopCatalogPersistence {
  sharedNoopCatalog ??= new NoopCatalogPersistence();
