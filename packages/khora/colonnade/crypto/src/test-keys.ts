import { TestSqlCipherKeyProvider } from "@khoralabs/sqlite-crypto";
...
export class TestKeyProvider implements EncryptionKeyProvider {
  private readonly sqlCipher = new TestSqlCipherKeyProvider({
    khora: TEST_KHORA_SQLCIPHER_KEY,
    registry: TEST_REGISTRY_SQLCIPHER_KEY,
  });
...
export function applyTestEncryptionEnv(): void {
  process.env[EnvKeyProvider.KHORA_SQLCIPHER_ENV] = TEST_KHORA_SQLCIPHER_KEY;
