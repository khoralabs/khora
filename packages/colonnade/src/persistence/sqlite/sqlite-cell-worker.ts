...
import { createOutboxPayloadCodec, openMaybeEncryptedDatabaseSync } from "../../crypto";
import type { DiscardInboxEntriesInput } from "../core";
...
let strategy: SqliteCellPersistence | undefined;
...
self.onmessage = (ev: MessageEvent<InitMsg | RpcReq>) => {
  ...
  if (msg.kind === "init") {
    ...
    strategy = new SqliteCellPersistence(db, msg.cellId, { outboxPayloadCodec });
