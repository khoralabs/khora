...
/** Thin facade over {@link CatalogPersistence}; space for shared validation later. */
export class CatalogPersistenceClient implements CatalogPersistence {
  ...
  constructor(private readonly strategy: CatalogPersistence) {
